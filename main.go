...
import (
	...
	"github.com/QuantumNous/the-one/router"
	"github.com/QuantumNous/the-one/service"
	"github.com/QuantumNous/the-one/service/authz"
	_ "github.com/QuantumNous/the-one/setting/performance_setting"
...
func main() {
	...
	common.SysLog("The One " + common.Version + " started")
	...
	server.Use(gin.CustomRecovery(func(c *gin.Context, err any) {
		...
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": gin.H{
				"message": fmt.Sprintf("Panic detected, error: %v. Please submit a issue here: https://github.com/Calcium-Ion/the-one", err),
				"type":    "the_one_panic",
			},
		})
	}))
