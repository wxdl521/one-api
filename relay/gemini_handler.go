...
func GeminiHelper(c *gin.Context, info *relaycommon.RelayInfo) (theOneError *types.TheOneError) {
...
func GeminiEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo) (theOneError *types.TheOneError) {
	info.InitChannelMeta(c)
