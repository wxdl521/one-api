...
import (
	...
	appconstant "github.com/QuantumNous/the-one/constant"
...
func ResponsesHelper(c *gin.Context, info *relaycommon.RelayInfo) (theOneError *types.TheOneError) {
	info.InitChannelMeta(c)
	if info.RelayMode == relayconstant.RelayModeResponsesCompact {
		switch info.ApiType {
		case appconstant.APITypeOpenAI, appconstant.APITypeCodex, appconstant.APITypeVolcEngineAgentPlan:
		default:
