...
func ClaudeHelper(c *gin.Context, info *relaycommon.RelayInfo) (theOneError *types.TheOneError) {
	...
	if !model_setting.GetGlobalSettings().PassThroughRequestEnabled &&
		...
		usage, theOneErr := chatCompletionsViaResponses(c, info, adaptor, openAIRequest)
		if theOneErr != nil {
			return theOneErr
		}
