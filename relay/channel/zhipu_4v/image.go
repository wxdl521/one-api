...
func zhipu4vImageHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (*dto.Usage, *types.TheOneError) {
		...
		default:
			...
			if err != nil {
				if service.IsPromptShotCompatibleRequest(c) {
					logger.LogError(c, "zhipu_image_get_b64_failed for promptshot request")
				} else {
