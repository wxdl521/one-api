...
func TestGeminiResponsesHandlerReturnsOpenAIResponsesJSON(t *testing.T) {
	...
	usage, theOneError := GeminiResponsesHandler(c, info, &http.Response{
...
func TestGeminiResponsesHandlerClosesBodyOnReadError(t *testing.T) {
	...
	usage, theOneError := GeminiResponsesHandler(c, newGeminiResponsesRelayInfo(false), &http.Response{Body: body})
...
func TestGeminiResponsesStreamHandlerReturnsOpenAIResponsesSSE(t *testing.T) {
	...
	usage, theOneError := GeminiResponsesStreamHandler(c, info, &http.Response{
