...
var ChannelBaseURLs = []string{
	...
	"",                                          //58
	"https://zhenze-huhehaote.cmecloud.cn/api/v3",   //59
...
var ChannelTypeNames = map[int]string{
	...
	ChannelTypeAICCSeedance:        "AICC Seedance",
	ChannelTypeVolcEngineAgentPlan: "VolcEngine Agent Plan",
}

// IsAgentPlanUsageChannelType reports channel types that may show official
// Agent Plan AFP usage. Legacy channels retain their explicit usage toggle;
// the dedicated Agent Plan channel enables it by default.
func IsAgentPlanUsageChannelType(channelType int) bool {
	return channelType == ChannelTypeVolcEngine ||
		channelType == ChannelTypeAdvancedCustom ||
		channelType == ChannelTypeVolcEngineAgentPlan
}
