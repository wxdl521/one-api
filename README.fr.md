...
<p align="center">
  <a href="https://raw.githubusercontent.com/Calcium-Ion/the-one/main/LICENSE">
    <img src="https://img.shields.io/github/license/Calcium-Ion/the-one?color=brightgreen" alt="licence">
  </a><!--
  --><a href="https://github.com/Calcium-Ion/the-one/releases/latest">
    <img src="https://img.shields.io/github/v/release/Calcium-Ion/the-one?color=brightgreen&include_prereleases" alt="version">
  </a><!--
  --><a href="https://hub.docker.com/r/CalciumIon/the-one">
    <img src="https://img.shields.io/badge/docker-dockerHub-blue" alt="docker">
  </a><!--
  --><a href="https://goreportcard.com/report/github.com/Calcium-Ion/the-one">
    <img src="https://goreportcard.com/badge/github.com/Calcium-Ion/the-one" alt="GoReportCard">
  </a>
</p>

<p align="center">
  <a href="https://trendshift.io/repositories/20180" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/20180" alt="QuantumNous%2Fthe-one | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>
  <br>
  <a href="https://hellogithub.com/repository/QuantumNous/the-one" target="_blank">
    <img src="https://api.hellogithub.com/v1/widgets/recommend.svg?rid=539ac4217e69431684ad4a0bab768811&claim_uid=tbFPfKIDHpc4TzR" alt="Featured｜HelloGitHub" style="width: 250px; height: 54px;" width="250" height="54" />
  </a><!--
  --><a href="https://www.producthunt.com/products/the-one/launches/the-one?embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-the-one" target="_blank" rel="noopener noreferrer">
    <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1047693&theme=light&t=1769577875005" alt="The One - All-in-one AI asset management gateway. | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" />
  </a>
</p>
...
<p align="center">
  ...
  --><a href="https://www.compshare.cn/?ytag=GPU_yy_gh_theone" target="_blank">
...
<p align="center">
  <a href="https://www.jetbrains.com/?from=the-one" target="_blank">
    <img src="https://resources.jetbrains.com/storage/products/company/brand/logos/jb_beam.png" alt="JetBrains Logo" width="120" />
  </a>
</p>

<p align="center">
  <strong>Merci à <a href="https://www.jetbrains.com/?from=the-one">JetBrains</a> pour avoir fourni une licence de développement open-source gratuite pour ce projet</strong>
</p>
...
```bash
# Cloner le projet
git clone https://github.com/QuantumNous/the-one.git
cd the-one
...
docker pull calciumion/the-one:latest

# Utilisation de SQLite (par défaut)
docker run --name the-one -d --restart always \
  -p 3000:3000 \
  -e TZ=Asia/Shanghai \
  -v ./data:/data \
  calciumion/the-one:latest
...
📖 Pour plus de méthodes de déploiement, veuillez vous référer à [Guide de déploiement](https://docs.theone.pro/en/docs/installation)
...
### 📖 [Documentation officielle](https://docs.theone.pro/en/docs) | [![Demander à DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/QuantumNous/the-one)
...
| Catégorie | Lien |
|------|------|
| 🚀 Guide de déploiement | [Documentation d'installation](https://docs.theone.pro/en/docs/installation) |
| ⚙️ Configuration de l'environnement | [Variables d'environnement](https://docs.theone.pro/en/docs/installation/config-maintenance/environment-variables) |
| 📡 Documentation de l'API | [Documentation de l'API](https://docs.theone.pro/en/docs/api) |
| ❓ FAQ | [FAQ](https://docs.theone.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.theone.pro/en/docs/support/community-interaction) |

---

## ✨ Fonctionnalités clés

> Pour les fonctionnalités détaillées, veuillez vous référer à [Présentation des fonctionnalités](https://docs.theone.pro/en/docs/guide/wiki/basic-concepts/features-introduction) |
...
- 🔍 Requête de quota d'utilisation de clé (avec [the-one-key-tool](https://github.com/Calcium-Ion/the-one-key-tool))

### 🚀 Fonctionnalités avancées

**Prise en charge des formats d'API:**
- ⚡ [OpenAI Responses](https://docs.theone.pro/en/docs/api/ai-model/chat/openai/create-response)
- ⚡ [OpenAI Realtime API](https://docs.theone.pro/en/docs/api/ai-model/realtime/create-realtime-session) (y compris Azure)
- ⚡ [Claude Messages](https://docs.theone.pro/en/docs/api/ai-model/chat/create-message)
- ⚡ [Google Gemini](https://doc.theone.pro/en/api/google-gemini-chat)
- 🔄 [Modèles Rerank](https://docs.theone.pro/en/docs/api/ai-model/rerank/create-rerank) (Cohere, Jina)
...
> Pour les détails, veuillez vous référer à [Documentation de l'API - Interface de passerelle](https://docs.theone.pro/en/docs/api)

| Type de modèle | Description | Documentation |
|---------|------|------|
| 🤖 OpenAI-Compatible | Modèles compatibles OpenAI | [Documentation](https://docs.theone.pro/en/docs/api/ai-model/chat/openai/createchatcompletion) |
| 🤖 OpenAI Responses | Format OpenAI Responses | [Documentation](https://docs.theone.pro/en/docs/api/ai-model/chat/openai/createresponse) |
| 🎨 Midjourney-Proxy | [Midjourney-Proxy(Plus)](https://github.com/novicezk/midjourney-proxy) | [Documentation](https://doc.theone.pro/api/midjourney-proxy-image) |
| 🎵 Suno-API | [Suno API](https://github.com/Suno-API/Suno-API) | [Documentation](https://doc.theone.pro/api/suno-music) |
| 🔄 Rerank | Cohere, Jina | [Documentation](https://docs.theone.pro/en/docs/api/ai-model/rerank/creatererank) |
| 💬 Claude | Format Messages | [Documentation](https://docs.theone.pro/en/docs/api/ai-model/chat/createmessage) |
| 🌐 Gemini | Format Google Gemini | [Documentation](https://docs.theone.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta) |
| 🔧 Dify | Mode ChatFlow | - |
...
- [Interface de discussion (Chat Completions)](https://docs.theone.pro/en/docs/api/ai-model/chat/openai/createchatcompletion)
- [Interface de réponse (Responses)](https://docs.theone.pro/en/docs/api/ai-model/chat/openai/createresponse)
- [Interface d'image (Image)](https://docs.theone.pro/en/docs/api/ai-model/images/openai/post-v1-images-generations)
- [Interface audio (Audio)](https://docs.theone.pro/en/docs/api/ai-model/audio/openai/create-transcription)
- [Interface vidéo (Video)](https://docs.theone.pro/en/docs/api/ai-model/audio/openai/createspeech)
- [Interface d'incorporation (Embeddings)](https://docs.theone.pro/en/docs/api/ai-model/embeddings/createembedding)
- [Interface de rerank (Rerank)](https://docs.theone.pro/en/docs/api/ai-model/rerank/creatererank)
- [Conversation en temps réel (Realtime)](https://docs.theone.pro/en/docs/api/ai-model/realtime/createrealtimesession)
- [Discussion Claude](https://docs.theone.pro/en/docs/api/ai-model/chat/createmessage)
- [Discussion Google Gemini](https://docs.theone.pro/en/docs/api/ai-model/chat/gemini/geminirelayv1beta)
...
> [!TIP]
> **Dernière image Docker:** `calciumion/the-one:latest`
...
| `PYROSCOPE_APP_NAME` | Nom de l'application Pyroscope | `the-one` |
...
| `HOSTNAME` | Nom d'hôte tagué pour Pyroscope | `the-one` |

📖 **Configuration complète:** [Documentation des variables d'environnement](https://docs.theone.pro/en/docs/installation/config-maintenance/environment-variables)
...
2. Recherchez **The One** dans le magasin d'applications
...
| Projet | Description |
|------|------|
| [the-one-key-tool](https://github.com/Calcium-Ion/the-one-key-tool) | Outil de recherche de quota d'utilisation avec une clé |
| [the-one-horizon](https://github.com/Calcium-Ion/the-one-horizon) | Version optimisée haute performance de The One |
...
| 📘 FAQ | [FAQ](https://docs.theone.pro/en/docs/support/faq) |
| 💬 Interaction avec la communauté | [Canaux de communication](https://docs.theone.pro/en/docs/support/community-interaction) |
| 🐛 Commentaires sur les problèmes | [Commentaires sur les problèmes](https://docs.theone.pro/en/docs/support/feedback-issues) |
| 📚 Documentation complète | [Documentation officielle](https://docs.theone.pro/en/docs) |
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=Calcium-Ion/the-one&type=Date)](https://star-history.com/#Calcium-Ion/the-one&Date)
...
### 💖 Merci d'utiliser The One

Si ce projet vous est utile, bienvenue à nous donner une ⭐️ Étoile！

**[Documentation officielle](https://docs.theone.pro/en/docs)** • **[Commentaires sur les problèmes](https://github.com/Calcium-Ion/the-one/issues)** • **[Dernière version](https://github.com/Calcium-Ion/the-one/releases)**
