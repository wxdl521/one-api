...
import (
	...
	"github.com/QuantumNous/the-one/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "the-one:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "the-one:channel_affinity_usage_cache_stats:v1"
)
