...
func printHelp() {
	fmt.Println("TheOne(Based OneAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: QuantumNous - https://github.com/QuantumNous/the-one")
	fmt.Println("Usage: theone [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
...
func InitEnv() {
	...
	MiniAppAllowedModels = GetEnvOrDefaultString("MINIAPP_ALLOWED_MODELS", "")
	...
	CriticalRateLimitNum = GetEnvOrDefault("CRITICAL_RATE_LIMIT", DefaultCriticalRateLimitNum)
	CriticalRateLimitDuration = int64(GetEnvOrDefault("CRITICAL_RATE_LIMIT_DURATION", DefaultCriticalRateLimitDuration))
