...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.TheOneError {
	...
	key, index, theOneError := channel.GetNextEnabledKey()
	if theOneError != nil {
		return theOneError
	}
